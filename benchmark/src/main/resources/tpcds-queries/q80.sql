WITH ssr AS (
  ...
  WHERE ss_sold_date_sk = d_date_sk AND d_date BETWEEN CAST('2000-08-23' AS DATE) AND DATE_ADD(CAST('2000-08-23' AS DATE), 30)
...
wsr AS (
  ...
  WHERE ws_sold_date_sk = d_date_sk AND d_date BETWEEN CAST('2000-08-23' AS DATE) AND DATE_ADD(CAST('2000-08-23' AS DATE), 30)
